...
v1.174 · 2026-05-21 · Author: JFC + Codex
...
Current: **v1.174**. Increment by 0.1 for each meaningful change. Update the CSS master block comment header on every version bump.
