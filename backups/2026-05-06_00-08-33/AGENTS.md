...
v1.143 · 2026-05-05 · Author: JFC + Codex
...
Current: **v1.143**. Increment by 0.1 for each meaningful change. Update the CSS master block comment header on every version bump.
